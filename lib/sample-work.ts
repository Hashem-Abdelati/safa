  ...
  en: [
    {
      ...
      name: "Aster Clinic",
      description: "A premium private clinic website for aesthetic consultation, treatment education, doctor profiles, results, and booking.",
      ...
      proof: ["Results portfolio supports before-and-after style presentation", "Treatment pages explain suitability and aftercare", "Booking and contact paths stay direct"],
      features: ["Treatment directory", "Results portfolio", "Consultation booking"],
      href: "/samples/clinic/index.html",
      image: "/sample-previews/aster-clinic.jpg",
  ...
  ar: [
    {
      ...
      name: "Aster Clinic",
      description: "موقع مصقول لعيادة تجميل خاصة يعرض الاستشارات، العلاجات، الأطباء، النتائج، والحجز المباشر.",
      ...
      proof: ["معرض نتائج يدعم عرض قبل وبعد", "صفحات العلاج تشرح الملاءمة والرعاية اللاحقة", "مسارات الحجز والتواصل واضحة"],
      features: ["دليل علاجات", "معرض نتائج", "حجز استشارة"],
      href: "/samples/clinic/index.html",
      image: "/sample-previews/aster-clinic.jpg",
